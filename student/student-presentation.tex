...
\begin{frame}
  ...
  Proprietary
  \begin{itemize}
  \item May cost \textcolor{beamer@myblue}{money} (not necessarily though!)
  \item \textcolor{beamer@myblue}{Not} allowed to see how it works
  \item You're only \textcolor{beamer@myblue}{licensed} to use it and don't own it
  \item Sometimes less \textcolor{beamer@myblue}{secure}, as fewer experts get to look at how it was created
  \item May \textcolor{beamer@myblue}{lock} users into a product that won't work with other systems once they've learned it
  \item Can add arbitrary \textcolor{beamer@myblue}{restrictions} (like taking away features or keeping you from using it under arbitrary circumstances) to protect their product or get you to upgrade
  \end{itemize}
