...
\begin{frame}
  ...
  \begin{center}
    ...
    \end{LARGE}
    \only<2>{\begin{block}
      So if a project is open, you can explore it, share it with
      others, duplicate it and spin off your own variants, and work
      with the creators to make it better!
    \end{block}}
\end{center}
\end{frame}
