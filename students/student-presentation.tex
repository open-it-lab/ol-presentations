...
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{../img/bg-small.png}}
...
\begin{frame}
  ...
  \begin{center}
    ...
    \only<2,3>{\textcolor{beamer@myblue}{Project} $\rightarrow$ Programmer(s) $\rightarrow$ Code $\rightarrow$ Hardware}
    \only<4,5,6>{Project $\rightarrow$ \textcolor{beamer@myblue}{Programmer(s)} $\rightarrow$ Code $\rightarrow$ Hardware}
    \only<7>{Project $\rightarrow$ Programmer(s) $\rightarrow$ \textcolor{beamer@myblue}{Code} $\rightarrow$ Hardware}
    \only<8>{Project $\rightarrow$ Programmer(s) $\rightarrow$ Code $\rightarrow$ \textcolor{beamer@myblue}{Hardware}}
  \end{center}
  ...
  \only<3>{
    ...
    \item Give tasks to the programmer(s) hired to work on the project
    \end{itemize}
    \putat{85}{0}{\includegraphics[width=0.5\textwidth]{../img/red-tape}}
    % \begin{center} \includegraphics[width=0.75\textwidth]{../img/red-tape} \end{center}
  }
  \only<4>{
    \begin{center}
  ...
  \only<5>{
    \begin{center}
      \includegraphics[height=0.6\textheight]{../img/geek}
      \includegraphics[height=0.6\textheight]{../img/ada-byron}
    \end{center}
  }
  \only<6>{
    Programmers create all kinds of software
    \begin{center}
      \begin{itemize}
      \item Computer applications
      \item Web applications
      \item Apps for phones
      \item Games
      \item Logic for cars, microwaves, credit card readers, etc.
      \item Databases
      \item Software that tests other software
      \item Software that runs a computer (Operating System)
      \item Software that helps other programmers create software
      \end{itemize}
    \end{center}
  ...
  \only<7>{
    \begin{center}
      ...
      \item Can be valuable to businesses or corporations, so they may not \textcolor{beamer@myblue}{share} code they create
      \end{itemize}
    \end{center}
  }
  \only<8>{
    \begin{center}
      \includegraphics[width=0.35\textwidth]{../img/compiling}
    \end{center}
    \begin{itemize}
    \item Hardware can only understand 0s and 1s, so code must be \textcolor{beamer@myblue}{compiled} to run on hardware
    % \item Compiling is just the process of turning the code into 0s and 1s
    \item It can take a long time, or be really fast (so fast, its done instantly) depending on how big your program is
    \end{itemize}
  }
  \end{overlayarea}
\end{frame}
...
\begin{frame}
  ...
  \begin{overlayarea}{\textwidth}{\textheight}
    ...
    \end{description}
    \begin{center}
      \only<1>{\includegraphics[width=0.4\textwidth]{../img/tux-question-3}}
