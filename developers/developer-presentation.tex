...
% \begin{frame}
%   % \frametitle{Software Freedom Day}
%   \vspace{-1em}
%   \begin{center} \includegraphics[width=0.9\textwidth]{../img/sfd} \end{center}
%   % \href{http://softwarefreedomday.org/}{http://softwarefreedomday.org/}
%   \begin{large}
%     \begin{itemize}
...
%       \column{0.45\textwidth}
%       \begin{center}
%         \includegraphics[height=0.2\textheight]{../img/linux-logo}
%       \end{center}

%       \begin{itemize}
%       \item Built from the ground-up to be a multi-user environment
%       \item Same kernel works on almost any device, from phones to supercomputers
%       \item Open development: anyone can report bugs, contribute, read the code
%       \item Choice: no penalty for using any program you choose
%       \item Secure: used by the NSA!
%       \item Cost: \$0
%       \end{itemize}

%       \column{0.45\textwidth}
%       \begin{center}
%         \includegraphics[height=0.2\textheight]{../img/microsoft-logo}
%       \end{center}

%       \begin{itemize}
%       \item Built from a single-user operating system
%       \item Different products for supercomputers, phones, or desktop PCs
%       \item Closed development: users cannot read the code, or contribute anything
%       \item Less choice: includes unremovable software
%       \item No way to know if it is secure
%       \item Cost: \$220 (for best version)
%       \end{itemize}
