...
\begin{frame}
  % \begin{overlayarea}{\textwidth}{\textheight}
    \begin{columns}
      ...
      \begin{itemize}
      \item Built from legacy operating systems that for one user
      \item Different products for supercomputers or phones, or desktop PCs
      \item Closed development: users cannot read the code, or contribute anything
      \item No choice: Microsoft bundles unremovable software
